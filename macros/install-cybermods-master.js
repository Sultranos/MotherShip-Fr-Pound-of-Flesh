...
async function installCybermodsComplete() {
    ...
    const installChoice = await foundry.applications.api.DialogV2.wait({
        window: { title: "Installation Cybermods Pound of Flesh" },
    ...
    await foundry.applications.api.DialogV2.prompt({
        window: { title: "Installation Cybermods - Rapport" },
